	...
	<form method="post" class="wp-aas-attachment-form">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="text" name="wp_aas_pro_attachment_title" value="<?php echo wp_aas_pro_esc_attr($attachment_post->post_title); ?>" class="large-text wp-aas-attachment-title" id="wp-aas-attachment-title" />
			...
			<tr>
				...
				<td>
					<input type="text" name="wp_aas_pro_attachment_alt" value="<?php echo wp_aas_pro_esc_attr($alt_text); ?>" class="large-text wp-aas-attachment-alt-text" id="wp-aas-attachment-alt-text" />
					<span class="description"><?php _e('Enter image alternative text.', 'accordion-and-accordion-slider'); ?></span>
				</td>
			</tr>	
			
			<tr>
				<th><label for="wp-aas-attachment-caption"><?php _e('Caption', 'accordion-and-accordion-slider'); ?>:</label></th>
				<td>
					<textarea name="wp_aas_pro_attachment_caption" class="large-text wp-aas-attachment-caption" id="wp-aas-attachment-caption"><?php echo wp_aas_pro_esc_attr($attachment_post->post_excerpt); ?></textarea>
					<span class="description"><?php _e('Enter image caption.', 'accordion-and-accordion-slider'); ?></span>
				</td>
			</tr>	
			...
			<tr>
				...
				<td>
					<input type="text" name="wp_aas_pro_attachment_link" value="<?php echo esc_url($attachment_link); ?>" class="large-text wp-aas-attachment-link" id="wp-aas-attachment-link" />
