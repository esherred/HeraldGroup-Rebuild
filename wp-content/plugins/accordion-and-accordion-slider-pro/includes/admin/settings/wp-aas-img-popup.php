...
<div class="wp-aas-img-data-wrp wp-aas-hide">
	<div class="wp-aas-img-data-cnt">
		...
		<div class="wp-aas-img-cnt-block">
			<div class="wp-aas-popup-close wp-aas-popup-close-wrp"><img src="<?php echo WP_AAS_PRO_URL; ?>assets/images/close.png" alt="<?php _e('Close (Esc)', 'accordion-and-accordion-slider'); ?>" title="<?php _e('Close (Esc)', 'accordion-and-accordion-slider'); ?>" /></div>
