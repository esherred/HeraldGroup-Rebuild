...
$visible_panels_960 		= get_post_meta( $post->ID, $prefix.'visible_panels_960', true );
$visible_panels_800			= get_post_meta( $post->ID, $prefix.'visible_panels_800', true );
$visible_panels_650 		= get_post_meta( $post->ID, $prefix.'visible_panels_650', true );
$visible_panels_500 		= get_post_meta( $post->ID, $prefix.'visible_panels_500', true );
	...
	<div id="wp-aas-sdetails" class="wp-aas-sdetails wpaas-carousel">
		...
		<hr>	
			<tbody>
				<tr valign="top">					
					...
					<td>
					<input type="number" min="100"  name="<?php echo $prefix; ?>width" value="<?php echo wp_aas_pro_esc_attr($width); ?>"> px<br/>
				...
				<tr valign="top">
					...
					<td>
						<input type="number" min="200" name="<?php echo $prefix; ?>height" value="<?php echo wp_aas_pro_esc_attr($height); ?>"> px<br/>
				...
				<tr valign="top">					
					...
					<td>
					<input type="number" min="1" step="1" name="<?php echo $prefix; ?>visible_panels" value="<?php echo wp_aas_pro_esc_attr($visible_panels); ?>"><br/>
				...
				<tr valign="top">
					...
					<td>
						<input type="number"  name="<?php echo $prefix; ?>panel_distance" value="<?php echo wp_aas_pro_esc_attr($panel_distance); ?>"><br/>
				...
				<tr valign="top">					
					...
					<td>						
						<input type="text"  name="<?php echo $prefix; ?>max_openedaccordion_size" value="<?php echo wp_aas_pro_esc_attr($max_openedaccordion_size); ?>"> <br/>
				...
				<tr valign="top">
					<td scope="row">
						<label><?php _e('Fancy Box', 'accordion-and-accordion-slider'); ?></label>
					</td>
					<td>
						<input type="radio" name="<?php echo $prefix; ?>fancy_box" value="true" <?php checked( 'true', $fancy_box ); ?>>True
						<input type="radio" name="<?php echo $prefix; ?>fancy_box" value="false" <?php checked( 'false', $fancy_box ); ?>>False<br/>
						<em style="font-size:11px;"><?php _e('Enable Fancy Box or not','accordion-and-accordion-slider'); ?></em>
					</td>
				</tr>
			</tbody>	
		</table>
		...
		<table class="form-table wp-aas-sdetails-tbl">
			...
			<tbody>
				<tr valign="top">					
					<td scope="row">
						<label><?php _e('Visible Accordion Panels (width: 960)', 'accordion-and-accordion-slider'); ?></label>
					</td>
					<td>
					<input type="number" min="1" step="1" name="<?php echo $prefix; ?>visible_panels_960" value="<?php echo wp_aas_pro_esc_attr($visible_panels_960); ?>"><br/>
					<em style="font-size:11px;"><?php _e('Enter Visible Accordion Panels at a time. eg. 4','accordion-and-accordion-slider'); ?></em>
					</td>
				</tr>
				<tr valign="top">					
					<td scope="row">
						<label><?php _e('Visible Accordion Panels (width: 800)', 'accordion-and-accordion-slider'); ?></label>
					</td>
					<td>
					<input type="number" min="1" step="1" name="<?php echo $prefix; ?>visible_panels_800" value="<?php echo wp_aas_pro_esc_attr($visible_panels_800); ?>"><br/>
					<em style="font-size:11px;"><?php _e('Enter Visible Accordion Panels at a time. eg. 3','accordion-and-accordion-slider'); ?></em>
					</td>
				</tr>
				<tr valign="top">					
					<td scope="row">
						<label><?php _e('Visible Accordion Panels (width: 650)', 'accordion-and-accordion-slider'); ?></label>
					</td>
					<td>
					<input type="number" min="1" step="1" name="<?php echo $prefix; ?>visible_panels_650" value="<?php echo wp_aas_pro_esc_attr($visible_panels_650); ?>"><br/>
					<em style="font-size:11px;"><?php _e('Enter Visible Accordion Panels at a time. eg. 2','accordion-and-accordion-slider'); ?></em>
					</td>
				</tr>
				<tr valign="top">					
					<td scope="row">
						<label><?php _e('Visible Accordion Panels (width: 500)', 'accordion-and-accordion-slider'); ?></label>
					</td>
					<td>
					<input type="number" min="1" step="1" name="<?php echo $prefix; ?>visible_panels_500" value="<?php echo wp_aas_pro_esc_attr($visible_panels_500); ?>"><br/>
					<em style="font-size:11px;"><?php _e('Enter Visible Accordion Panels at a time. eg. 1','accordion-and-accordion-slider'); ?></em>
					</td>
				</tr>
			</tbody>
		</table>
