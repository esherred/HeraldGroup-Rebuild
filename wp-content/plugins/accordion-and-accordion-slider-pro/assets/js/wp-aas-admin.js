jQuery( document ).ready(function( $ ) {
					...
					if( attachment_id && attachment.sizes && multiple_img == true ) {
						...
						showfield.append('\
							<div class="wp-aas-img-wrp">\
								...
								<input type="hidden" class="wp-aas-attachment-no" name="wp_aas_pro_img[]" value="'+attachment_id+'" />\
							</div>\
								');
	...
	$(document).on('click', '.wp-aas-img-wrp .wp-aas-edit-img', function(){
		...
		var data = {
                        action      	: 'wp_aas_pro_get_attachment_edit_form',
	...
	$(document).on('click', '.wp-aas-save-attachment-data', function(){
		...
		var data = {
                        action      	: 'wp_aas_pro_save_attachment_data',
...
function wp_aas_pro_hide_popup() {
