...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/assets/js/scripts.min.js?v=1', array('jquery'), '1.0.0'); // Custom scripts
...
{
    wp_register_style('html5blank', get_template_directory_uri() . '/assets/css/style.min.css?v=2', array(), '1.0', 'all');
